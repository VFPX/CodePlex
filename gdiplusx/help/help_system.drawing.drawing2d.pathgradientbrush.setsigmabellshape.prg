...
** http://msdn2.microsoft.com/en-us/library/bs92fkt6.aspx
...
myPGBrush.SetSigmaBellShape(0.5, 1.0)

* Move the brush down by 100 by Applying the translate
* transform to the brush.
myPGBrush.TranslateTransform(0, 100, .Drawing2D.MatrixOrder.Append)

* Draw the brush to the screen again after setting the blend and applying the transforms.
