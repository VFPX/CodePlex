...
#DEFINE C_BADCALL1_LOC	"The Grid Builder cannot be run as a standalone application. Use BUILDER.APP instead."
#DEFINE C_BADCALL2_LOC	"The proper context for the Grid Builder has not been established."
#DEFINE C_VCX			"gridbldr.vcx"
#DEFINE C_MAIN			"GRIDMAIN"
