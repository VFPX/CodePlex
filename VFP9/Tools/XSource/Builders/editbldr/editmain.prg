...
#DEFINE C_BADCALL1_LOC	"The Edit/Text Box Builder cannot be run as a standalone application. Use BUILDER.APP instead."
#DEFINE C_BADCALL2_LOC	"The proper context for the this Builder has not been established."
#DEFINE C_VCX			"editbldr.vcx"
#DEFINE C_MAIN			"EDITMAIN"
