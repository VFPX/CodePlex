* Program:		listMain.PRG
* Description:	Main program file for List Builder
*               Intended to be called from BUILDER.APP, so all environment
*               and other settings should have been made there.
* Version:		.050
* -----------------------------------------------------------------------------------------

#DEFINE C_BADCALL1_LOC	"This Builder cannot be run as a standalone application. Use BUILDER.APP instead."
#DEFINE C_BADCALL2_LOC	"The proper context for this Builder has not been established."
#DEFINE C_VCX			"listbldr.vcx"
#DEFINE C_MAIN			"LISTMAIN"
