...
#DEFINE C_BADCALL1_LOC	"The Command Builder cannot be run as a standalone application. Use BUILDER.APP instead."
#DEFINE C_BADCALL2_LOC	"The proper context for the Command Builder has not been established."
#DEFINE C_VCX			"cmdbldr.vcx"
