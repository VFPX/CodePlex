...
* Default wizard directory -- relative to SYS(2004)
* Used in VisualStyle::FindStyleFile()
#define WIZ_DIR		'\WIZARDS\'

* Help topic ID
*- help codes
#define HELP_wizReport_Wizard_Finish				15825428
#define HELP_wizReport_Wizard_Step_5				15825427
#define HELP_wizReport_Wizard_Step_4				15825426
#define HELP_wizReport_Wizard_Step_3				15825425
#define HELP_wizReport_Wizard_Step_2				15825424
#define HELP_wizReport_Wizard_Step_1a    			95825522
#define HELP_wizReport_Wizard_Step_1				15825423
#define HELP_wizReport_Wizard						15825422

#define  HELP_ID    HELP_wizReport_Wizard		&& 1895825422

* Localization strings for the Report Wizard UI
*
#define STEP1_LOC 'Step 1 - Select Fields'
#define STEP1a_LOC 'Step 2 - Group Records'
#define STEP2_LOC 'Step 3 - Choose Report Style'
#define STEP3_LOC 'Step 4 - Define Report Layout'
#define STEP4_LOC 'Step 5 - Sort Records'
#define STEP5_LOC 'Step 6 - Finish'
...
#define RPT_BMP1a 'BMPS\GRPRPT2.BMP'
#define RPT_BMP2 'BMPS\EXECRPT.BMP'
#define RPT_BMP3 'BMPS\MCRPTHZ1.BMP'
...
#define DESC1a_LOC "How do you want to group your records? " +;
                  "You can select up to three levels of groupings." + CHR(13) + CHR(13) + ;
                  "To specify a broader criteria for the grouping, click Grouping and Summary Options."

#define DESC2_LOC "How do you want your report to look?"

#define DESC3_LOC "What kind of layout do you want?" + CHR(13) + CHR(13) + ;
                  "In a column layout, the field and its data are in one column. In a row layout, they are in one row."
...
#DEFINE I_STYLE_PREDEFINED		3	&& how many pre-defined styles are we supplying?
