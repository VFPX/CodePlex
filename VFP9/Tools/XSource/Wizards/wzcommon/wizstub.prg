...
set classlib to ("<<Insert the name of the class library that contains your wizard>>")

public oWizard

* The name "oWizard" is used in automated testing and should *NOT* be changed.

oWizard = createobj("<<Insert the name of your wizard>>", m.cOutFileVarName, m.p2, m.p3, m.p4, ;
