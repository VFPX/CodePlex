...
//     [System.Security.SuppressUnmanagedCodeSecurityAttribute()]
    internal static class SafeNativeMethods 
    {
        ...
        [DllImport(ExternDll.User32, ExactSpelling=true, CharSet=CharSet.Auto)]
        internal static extern int MapWindowPoints(IntPtr hWndFrom, IntPtr hWndTo, [In, Out] ref NativeMethods.POINT pt, int cPoints);
        ...
        internal static extern int GetTextExtentPoint32(IntPtr hDC, string str, int len, [In, Out] ref NativeMethods.POINT ptSize);
        ...
        internal static extern IntPtr CreateFontIndirect([In, Out, MarshalAs(UnmanagedType.AsAny)] ref object lf);
