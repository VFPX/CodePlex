...
namespace Microsoft.VisualStudio.Package
{
    ...
    internal class GlobalPropertyHandler : IDisposable
    {
        ...
        {           
            ...
            this.SetGlobalProperty(GlobalProperty.BuildingInsideVisualStudio.ToString(), true.ToString().ToLower());
            ...
            // project is calling the <MSBuild> task on another project. 
            this.SetGlobalProperty(GlobalProperty.RunCodeAnalysisOnce.ToString(), false.ToString().ToLower());
