...
namespace Microsoft.VisualStudio.Package
{
    ...
    public sealed class ProjectElement
    {
        ...
        internal ProjectElement(ProjectNode project, string itemPath, string itemType)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.ParameterCannotBeNullOrEmpty), "itemPath");
            }


            if (String.IsNullOrEmpty(itemType))
            {
                throw new ArgumentException(SR.GetString(SR.ParameterCannotBeNullOrEmpty), "itemType");
            }
        ...
        {
            Debug.Assert(String.Compare(attributeName, ProjectFileConstants.Include, true, CultureInfo.InvariantCulture) != 0, "Use rename as this won't work");
        ...
        public string GetMetadataAndThrow(string attributeName, Exception exception)
        {
            ...
            if (String.IsNullOrEmpty(attributeName) && exception != null)
            {
                if (String.IsNullOrEmpty(exception.Message))
                {
                    ...
                    string message = String.Format(CultureInfo.CurrentCulture, SR.GetString(SR.AttributeLoad), attributeName, this.itemProject.BaseURI.AbsoluteUrl);
