...
namespace Microsoft.VisualStudio.Package
{
    ...
    public class NestedProjectNode : HierarchyNode, IDisposable, IPropertyNotifySink
    {
        ...
        public virtual void Init(string fileNameParam, string destinationParam, string projectNameParam, __VSCREATEPROJFLAGS createFlags)
        {
            ...
            {
                throw new ArgumentException(SR.GetString(SR.ParameterCannotBeNullOrEmpty), "fileNameParam");
            }

            if (String.IsNullOrEmpty(destinationParam))
            {
                throw new ArgumentException(SR.GetString(SR.ParameterCannotBeNullOrEmpty), "destinationParam");
            }
