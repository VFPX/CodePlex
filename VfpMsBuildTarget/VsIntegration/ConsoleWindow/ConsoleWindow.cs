...
namespace VFPX.FoxProIntegration.FoxProConsole
{
    ...
    internal class ConsoleWindow : ToolWindowPane, IVsWindowPane, IConsoleText
    {
        ...
        public ConsoleWindow() : 
            this(new ServiceProvider((IOleServiceProvider)FoxProConsolePackage.GetGlobalService(typeof(IOleServiceProvider))))
        {}
        ...
        private IVsTextView TextView
        {
            get
            {
                ...
                FoxProLanguage language = globalProvider.GetService(typeof(FoxProLanguage)) as FoxProLanguage;
                if (null != language)
                {
                    ...
                    // Create a new FoxProSource object.
                    source = language.CreateSource(textLines) as FoxProSource;
                    // Set the ScopeCreator property so that we can use our AuthoringScope
                    // based on the FoxProEngine instead of the default one provided by the
                    ...
                    ConsoleAuthoringScope.FoxProConsole = this;
        ...
        /// is used to execute the text as an FoxPro expression.
        /// </summary>
        ...
        private void ShowContextMenu(object sender, EventArgs args)
        {
            ...
            // Show the menu.
            Guid menuGuid = GuidList.guidFoxProConsoleCmdSet;
            Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(
