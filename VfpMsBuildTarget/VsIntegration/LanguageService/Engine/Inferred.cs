...
namespace VFPX.FoxProIntegration.FoxProInference {
    ...
    public class ReflectedModule : Inferred {
        ...
        public void AddFoxProType(string name, Type type) {
            AddType(name, new InferredFoxProType(type));
        }
    ...
    public class InferredFoxProType : ReflectedType {
        public InferredFoxProType(Type type)
            : base(type) {
        }
