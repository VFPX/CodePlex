...
namespace VFPX.FoxProIntegration.FoxProInference {
    public class Locator : IAstWalker {
        ...
        // ClassDefinition
        public bool Walk(FoxPro.Compiler.Ast.ClassDefinition node) { current = node; return Process(node); }
        ...
        // FunctionDefinition
        public bool Walk(FoxPro.Compiler.Ast.FunctionDefinition node) { current = node; return Process(node); }
