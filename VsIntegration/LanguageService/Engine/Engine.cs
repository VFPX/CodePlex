...
namespace VFPX.FoxProIntegration.FoxProInference {
    public class Engine {
        ...
        public IList<Inferred> Infer(Node node, Scope scope) {
            ...
            } else if (node is FoxPro.Compiler.Ast.ClassDefinition) {
                inferred = InferClassDef((FoxPro.Compiler.Ast.ClassDefinition)node, scope);
            ...
            } else if (node is FoxPro.Compiler.Ast.FunctionDefinition) {
                inferred = InferFuncDef((FoxPro.Compiler.Ast.FunctionDefinition)node, scope);
        ...
        private List<Inferred> InferDictionaryExpression(DictionaryExpression node, Scope scope) {
            return MakeList(module.InferType(typeof(FoxPro.Runtime.Dict)));
        }
        ...
        private List<Inferred> InferListComp(ListComprehension node, Scope scope) {
            return MakeList(module.InferType(typeof(FoxPro.Runtime.List)));
        }
        ...
        private List<Inferred> InferTupleExpression(TupleExpression node, Scope scope) {
            return MakeList(module.InferType(typeof(FoxPro.Runtime.Tuple)));
        }
