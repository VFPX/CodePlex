...
namespace VFPX.FoxProIntegration.FoxProLanguageService {
    public partial class FoxProContainedLanguage : IVsContainedLanguageCodeSupport {
        private CodeDomFileCodeModel fileCodeModel;
        private VFPX.FoxProIntegration.CodeDomCodeModel.StringMerger stringMerger;
        ...
        public int IsValidID(string bstrID, out bool pfIsValidID) {
            ...
            // there is no FoxPro support for CodeModel (only FileCodeModel), so we assume that any
        ...
        private CodeDomFileCodeModel FileCodeModel {
            get {
                ...
                EnvDTE.DTE dte = FoxProPackage.GetGlobalService(typeof(EnvDTE._DTE)) as EnvDTE.DTE;
                IVsTextLines buffer;
                ...
                stringMerger = new VFPX.FoxProIntegration.CodeDomCodeModel.StringMerger(text);
