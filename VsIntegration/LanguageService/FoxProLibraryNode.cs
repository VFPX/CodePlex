...
namespace VFPX.FoxProIntegration.FoxProLanguageService {
    ...
    /// <summary>
    /// This is a specialized version of the LibraryNode that handles the FoxPro's
    ...
    /// </summary>
    internal class FoxProLibraryNode : LibraryNode {
        private IVsHierarchy ownerHierarchy;
        private uint fileId;
        private TextSpan sourceSpan;
        private string fileMoniker;

        internal FoxProLibraryNode(ScopeNode scope, string namePrefix, IVsHierarchy hierarchy, uint itemId) :
            base(scope.Name) {
        ...
        internal FoxProLibraryNode(FoxProLibraryNode node) :
            base(node) {
        ...
        protected override LibraryNode Clone() {
            return new FoxProLibraryNode(this);
        }
        ...
        private IntPtr FindDocDataFromRDT() {
            ...
            IVsRunningDocumentTable rdt = FoxProPackage.GetGlobalService(typeof(SVsRunningDocumentTable)) as IVsRunningDocumentTable;
            if (null == rdt) {
                return IntPtr.Zero;
            }
