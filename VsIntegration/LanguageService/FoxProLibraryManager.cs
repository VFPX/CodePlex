...
namespace VFPX.FoxProIntegration.FoxProLanguageService {
    ...
    /// <summary>
    /// This interface defines the service that finds FoxPro files inside a hierarchy
    /// and builds the informations to expose to the class view or object browser.
    /// </summary>
    [Guid(FoxProConstants.libraryManagerServiceGuidString)]
    public interface IFoxProLibraryManager {
    ...
    /// navigation tools (class view or object browser) from the FoxPro files inside a
    /// hierarchy.
    /// </summary>
    [Guid(FoxProConstants.libraryManagerGuidString)]
    internal class FoxProLibraryManager : IFoxProLibraryManager, IVsRunningDocTableEvents, IDisposable {

        /// <summary>
        /// Class storing the data about a parsing task on a FoxPro module.
        /// A module in FoxPro is a source file, so here we use the file name to
        /// identify it.
        /// </summary>
        ...
        public FoxProLibraryManager(IServiceProvider provider) {
