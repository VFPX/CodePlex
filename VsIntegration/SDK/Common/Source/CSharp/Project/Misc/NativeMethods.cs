...
namespace Microsoft.VisualStudio {
    ...
    internal static class NativeMethods 
	{
		...
		// Build options from the idl file. Delete them if they are part of the shell.
...
// POINT
        ...
        public static extern int WideCharToMultiByte(int codePage, int flags, [MarshalAs(UnmanagedType.LPWStr)]string wideStr, int chars, [In,Out] ref byte[] pOutBytes, int bufferBytes, IntPtr defaultChar, IntPtr pDefaultUsed);
