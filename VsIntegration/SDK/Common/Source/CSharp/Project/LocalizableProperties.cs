...
{    
    ...
    public class LocalizableProperties : ICustomTypeDescriptor
	{
		...
		public virtual Microsoft.VisualStudio.Package.DesignPropertyDescriptor CreateDesignPropertyDescriptor(PropertyDescriptor p) 
		{
			return new Microsoft.VisualStudio.Package.DesignPropertyDescriptor(p);
        }
