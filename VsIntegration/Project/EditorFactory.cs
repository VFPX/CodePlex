...
namespace VFPX.FoxProIntegration.FoxProProject
{
    ...
    public class EditorFactory : IVsEditorFactory
    {
        ...
        #region ctors
        public EditorFactory(FoxProProjectPackage package)
        {
        ...
        private IVsTextLines GetTextBuffer(System.IntPtr docDataExisting)
        {
            ...
            else
            {
                ...
                if (textLines == null)
                {
                    ...
                    NativeMethods.ThrowOnFailure((int)NativeMethods.VS_E_INCOMPATIBLEDOCDATA);
                }
        ...
        private IntPtr CreateDocumentView(string physicalView, IVsHierarchy hierarchy, uint itemid, IVsTextLines textLines, out string editorCaption, out Guid cmdUI)
        {
            ...
            NativeMethods.ThrowOnFailure((int)NativeMethods.VS_E_UNSUPPORTEDFORMAT);
