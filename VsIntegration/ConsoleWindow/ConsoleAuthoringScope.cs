...
namespace VFPX.FoxProIntegration.FoxProConsole
{
    ...
    /// FoxPro engine to get the informations about the objects as opposed to the standard scope
    ...
    public class ConsoleAuthoringScope : AuthoringScope
    {
        ...
        /// <summary>
        /// Get or Set the FoxPro console window used by all the instances of the scope.
        /// </summary>
        public static IConsoleText FoxProConsole
        {
            get { return console; }
            set { console = value; }
        }
        ...
        private static IEngine Engine
        {
            get
            {
                if (null == engine)
                {
                    IFoxProEngineProvider provider = (IFoxProEngineProvider)site.GetService(typeof(IFoxProEngineProvider));
        ...
        public override Declarations GetDeclarations(IVsTextView view, int line, int col, TokenInfo info, ParseReason reason)
        {
            ...
            string lineText = FoxProConsole.TextOfLine(line, col, true);
            if (null == lineText)
            {
            ...
            // FoxPro engine to evaluate the expression.
            if (0 == tokens.Count)
            {
